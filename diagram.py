...
# deviationE = np.std(resultE/siteNum,axis=0)

resultC = np.mean(specificHeat/siteNum,axis=0)
deviationC = np.sqrt(np.var(specificHeat/siteNum,axis=0)/size[0])
resultChi = np.mean(susceptibility/siteNum,axis=0)
deviationChi = np.sqrt(np.var(susceptibility/siteNum,axis=0)/size[0])
# print(resultC)
# print(deviationC)
# print(resultChi)
# print(deviationChi)
